...
- Znesek lahko v Cloudflare Pages okolju spremeniš z okoljsko spremenljivko `SHIPPING_AMOUNT_CENTS` (npr. `590` za 5,90 € ali `0` za brez poštnine). Košarica vrednost prebere prek `/api/cart-config`, zato prikaz v košarici ostane usklajen s Stripe Checkoutom.
